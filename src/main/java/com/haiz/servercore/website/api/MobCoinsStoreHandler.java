...
public final class MobCoinsStoreHandler implements HttpHandler {

    private final WebsiteModule module;

    public MobCoinsStoreHandler(WebsiteModule module) {
        this.module = module;
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        ApiUtils.sendJson(exchange, 200, module.getMobCoinsStoreItems());
    }
}
